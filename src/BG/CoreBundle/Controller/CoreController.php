...
class CoreController extends Controller
{
  ...
  public function indexAction()
  {
    ...
    return $this->render('BGCoreBundle:Core:index.html.twig');
  ...
  public function contactAction(Request $request)
  {
    ...
    return $this->redirectToRoute('bg_core_home');

    // La méthode longue new RedirectResponse($this->get('router')->generate('bg_core_home')); est parfaitement valable
  }
}
