...
namespace BG\PlatformBundle\Purger;
...
class AdvertPurger
{
  ...
  {
    $advertRepository      = $this->em->getRepository('BGPlatformBundle:Advert');
    $advertSkillRepository = $this->em->getRepository('BGPlatformBundle:AdvertSkill');
